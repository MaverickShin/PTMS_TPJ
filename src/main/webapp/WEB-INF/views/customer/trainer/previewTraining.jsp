...
function newTrainer(){
   ...
   var rb = document.getElementById("accept_button");
   var ac = document.getElementById("right_button");
...
function lotsOfReviews() {
   
   var lb = document.getElementById("left_button");
   var rb = document.getElementById("accept_button");
   var ab = document.getElementById("right_button");
...
<%@ include file="../../main/header.jsp" %>
   ...
   <section class="hero-wrap hero-wrap-2" style="background-image: url('${path}images/bg_2.jpg');" data-stellar-background-ratio="0.5">
     ...
     <div style="display: flex; flex:1; justify-content:center;">
       ...
       <div class="list_tab">
         <p id="left_button" onclick="newTrainer();">최신 등록순</p>
         <p id="accept_button" style="background-color: #a3cde3; color: white;">평점순</p>   
         <p id="right_button" onclick="lotsOfReviews();">후기 많은 순</p>      
       </div>
