    			...
    			<!-- <h3 class="mb-5">6 후기</h3>
	              ...
	              <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
	              	<div class="form-group">
	              		  <form action="requestTraining?TA_CD=${dto.TA_CD}" class="iptags">
	              		  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
			                <div class="form-group">
			                  <span class="fa fa-search"></span>
			                  <input type="date" class="iptags">
			                </div>
			              </form>
	              	</div>
		           ...
		           <div class="form-group">
	                ...
	                <c:if test="${selectCnt != 0}">
	                	<c:forEach var="dto" items="${petInfo}">
	                		<input type="checkbox" value="${dto.PET_ID}" name="PET_ID">${dto.PET_NM}
	                	</c:forEach>
	                </c:if>
	              </div>
