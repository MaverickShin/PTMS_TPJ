			...
			<div class="container">
				<div class="row no-gutters slider-text align-items-end">
					<div class="col-md-9 ftco-animate pb-5">
						...
						<h1 class="mb-0 bread" style = "font-family: 'Do Hyeon', sans-serif;">펫시터 매칭 결과</h1>
					</div>
				</div>
			</div>
		</section>

		<section class="ftco-section ftco-degree-bg" style = "font-family: 'Do Hyeon', sans-serif; font-size: 20px; padding-top: 30px;">
			<div class="container">
				<div class="row">
					
					<!-- 나의 반려동물  -->
					<div class="col-md-12" style = "margin-bottom:30px; border-bottom:2px solid #00bd56;">
						<div class="form-group">
							...
							<div class = "list_div2" style = "margin-top: 30px;">
				        		...
				        		<h5 style = "padding-bottom:20px; margin-top:30px; color:#00bd56;">서비스</h5>
				        		<div style = "display: grid; grid-template-columns: 1fr 1fr; border-bottom:1px solid #eeeeee;">
				        			<c:forEach var = "j" items = "${sv_no}" varStatus = "st">
						        		...
						        		<c:choose>
						        			<c:when test="${st.index == 0}">
						        				...
						        				<c:if test = "${j != 0}">
						        					<p class = "chk_p1"><label class = "chk_label1" for = "SV1_NO"><span class = "list_label_span1">미용 서비스</span><input type="checkbox" value="1" name="SV1_NO" class="sel_chk1" id = "SV1_NO" checked><span class = "checkbox_icon"></span></label></p>
						        				</c:if>
						        			</c:when>
						        			...
						        			<c:when test="${st.index == 1}">
						        				...
						        				<c:if test = "${j != 0}">
						        					<p class = "chk_p1"><label class = "chk_label1" for = "SV2_NO"><span class = "list_label_span1">놀이 서비스</span><input type="checkbox" value="2" name="SV2_NO" id = "SV2_NO" class="sel_chk1" checked ><span class = "checkbox_icon"></span></label></p>
						        				</c:if>
						        			</c:when>
						        			...
						        			<c:when test="${st.index == 2}">
						        				...
						        				<c:if test = "${j != 0}">
						        					<p class = "chk_p1"><label class = "chk_label1" for = "SV3_NO"><span class = "list_label_span1">산책 서비스</span><input type="checkbox" value="3" name="SV3_NO" id = "SV3_NO" class="sel_chk1" checked><span class = "checkbox_icon"></span></label></p>
						        				</c:if>
						        			</c:when>
						        		</c:choose>
						        	
				        			</c:forEach>
				        			<p class = "chk_p1"><label class = "chk_label1" for = "SV4_NO"><span style = "margin-right: 79px;">응급처치 서비스 (필수)</span><input type="checkbox" value="4" name="SV4_NO" class="sel_chk1" id = "SV4_NO"  value = "${dto.SV4_NO}" checked disabled><span class = "checkbox_icon"></span></label></p>
				        		</div>
				        		
				        		<div class= "row" style = "margin-top:30px; font-size: 18px !important;">
				        			<div class="col-md-4">
				        				<div class="form-group">
											<label class = "label" for = "START_DAY" style = "font-size: 20px; font-weight:normal;">요청 시작일</label>
											<input type="date" class="form-control" name="START_DAY" id = "START_DAY" value = "${WK_START}" style = "width:300px !important; font-size: 18px !important;">
										</div>
									</div>
									
									<div class="col-md-4">
										<div class="form-group">
											<label class = "label" for = "END_DAY" style = "font-size: 20px; font-weight:normal;">요청 종료일</label>
											<input type="date" class="form-control" name="END_DAY" id = "END_DAY" value = "${WK_END}" style = "width:300px !important; font-size: 18px !important;">
										</div>
									</div>
					...
					<div class="col-md-6" align = center>
						...
						<div class="select-wrap" style = "margin-bottom: 30px;">
	                        <label class="label" style = "font-size: 20px !important;">시터가 제공 가능한 서비스 입니다.</label>
                                </div>
					...
					<!-- 가능한 일정 선택하기 -->
					<div class="col-lg-12 sidebar pl-lg-5 ftco-animate" style = "margin-top: 30px; border-top: 1px solid #00bd56; padding-top: 40px;">
						<div class="col-md-12">
							<div class="form-group" align= center>
								<input type="submit" value="신청하기" class="btn btn-primary" style = "text-align:center; width:150px; padding-left:35px;  font-size: 24px !important;">
