...
<div style="display: flex; flex: 1; justify-content: center;">
	...
	<div class="container" style="margin-top: 50px;">
		<div class="row"
			...
			<c:if test="${cnt == 0}">
				<div>매칭결과가 없습니다. 다시 조건을 입력해 주세요.</div>
			</c:if>
		</div>
			...
			<div class="col-md-12" align="center">
				<div class="block-27">
					<ul>
						...
						<li><a href="sitterMatching?pageNum=${startPage - pageBlock}">&lt;</a></li>

						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							<c:if test="${i == currentPage}">
								<li class="active"><span><a href="sitterMatching?pageNum=${i}">${i}</a></span></li>
							</c:if>
