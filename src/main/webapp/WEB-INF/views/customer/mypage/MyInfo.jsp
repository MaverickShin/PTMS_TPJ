										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="password" class="form-control" name="CUST_PWD" id="CUST_PWD" value="${CustomerVO.getCUST_PWD()}"
														placeholder="비밀번호">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" class="form-control" name="CUST_EM" id="CUST_EM" value="${CustomerVO.getCUST_EM()}"
														placeholder="이메일">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="CUST_PH" id="CUST_PH" value="${CustomerVO.getCUST_PH()}"
														placeholder="연락처">
												</div>
											</div>
											<div class="col-md-7">
