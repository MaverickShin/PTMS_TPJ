...
public class SYMPTOM_INFO_CRAWLING {
	...
	public List<String> SymptomInfo() {
		...
		for (int i = 0; i < el1.size(); i++) {
			...
			if(el1.get(i).getText().equals("치료·예방")) {
				el1.get(i).click();
				break;
			}
		}
		...
		//iT/과학뉴스를 담은 div
		WebElement el2 = driver.findElement(By.id("section-list"));
		
		//div속에서 strong태그를 가진 모든 element를 받아온다.
		List<WebElement> el3 = el2.findElements(By.tagName("h4"));
